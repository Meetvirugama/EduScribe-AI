...
class CapabilityDetector:
    ...
    @staticmethod
    def detect(messages: List[Dict[str, Any]],
               expected_output_format: str = "text") -> Capabilities:
        cap = Capabilities()
...
class MetricsRecorder:
    ...
    @staticmethod
    def record(context: RequestContext, provider: str,
               model: str, latency: float, usage: dict) -> None:
