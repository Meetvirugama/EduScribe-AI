...
class BaseContentService:
    ...
    def _render_messages(self, system_msg: str, template_name: str, **kwargs) -> List[Dict[str, str]]:
    ...
    async def execute_with_retry(self, service_name: str, context: LectureContext, func, *args, **kwargs):
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt == max_retries - 1:
                    ...
                    logger.error(f"Service {service_name} completely failed after {max_retries} attempts.")
                    return None
