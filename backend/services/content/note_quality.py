...
class NoteQualityEvaluator:
    ...
    async def evaluate(
        ...
        system_msg = (
            ...
            "3. Clarity & Structure\n"
            "4. Exam Relevance (Is this genuine academic/technical material or is it administrative/promotional/logistical?)\n"
        ...
        prompt = (
            ...
            f"{topic_json.get('notes_markdown', str(topic_json))}\n\n"
            ...
            "Critically, evaluate if the topic is genuinely relevant for exam preparation. "
            "If it covers administrative details, promo codes, or audio checks, set \"is_relevant\": false.\n"
